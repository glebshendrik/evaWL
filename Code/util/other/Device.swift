...
class Device {
    ...
    static var isPhoneX: Bool {
       return version() == .iPhoneX || version() == .iPhoneXSMax || version() == .iPhoneXS || version() == .iPhoneXR || version() == .iPhone11 || version() == .iPhone11Pro || version() == .iPhone11ProMax
        //  return true
    }
    
    static var isPhone5: Bool {
       return version() == .iPhone5 || version() == .iPhone5S || version() == .iPhone5C || version() == .iPhoneSE
    }
    
    static var is678: Bool {
        return version() == .iPhone6 || version() == .iPhone6S || version() == .iPhone7 || version() == .iPhone8 || version() == .iPhoneSE20
    }
    ...
    static var isPlus: Bool {
        return version() == .iPhone6Plus || version() == .iPhone7Plus || version() == .iPhone8Plus || version() == .iPhone6SPlus  || version() == .iPhoneSE20
    }
    ...
    static func safeAreaHeight(_ withStatusBar: Bool = true) -> CGFloat {
        if #available(iOS 11.0, *) {
            ...
            if withStatusBar {
                return UIApplication.shared.statusBarFrame.height + topPadding + bottomPadding
            } else {
    ...
    static fileprivate func getVersion(code: String) -> Version {
        ...
        case "iPhone12,8":                               return .iPhoneSE20
    ...
    static var witdh = UIScreen.main.bounds.width
